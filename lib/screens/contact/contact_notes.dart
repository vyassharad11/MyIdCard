...
class _FullScreenBottomSheetState extends State<FullScreenBottomSheet> {
              ...
              Padding(
                ...
                child: Column(
                  children: [
                    ...
                    InkWell(
                      onTap: (){
                        showBottomSheetCompanyType((id, name) {
                          companyId = id;
                          selectedValue = name;
                          setState(() {
                      ...
                      child: Row(
                        mainAxisAlignment: MainAxisAlignment.spaceBetween,
                        children: [
                          Text(selectedValue.isNotEmpty ? selectedValue :AppLocalizations.of(context).translate('typeOfCompany'),
  ...
  showBottomSheetCompanyType(void Function(String id, String name) callBack) {
    showModalBottomSheet(
      context: context,
      isScrollControlled: true,
                  ...
                  itemBuilder: (context, index) {
                    ...
                    return GestureDetector(
                      onTap: () {
                        ...
                        callBack.call( item.id.toString(),
